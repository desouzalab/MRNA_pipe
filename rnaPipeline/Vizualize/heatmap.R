...
save_plot(paste0(outdir,"/heatmapTrueFirst_no_row_scale",args$name_dataset,".png"),HMTrueFirst)
...
save_plot(paste0(outdir,"/heatmapTrueFirst_row_scale",args$name_dataset,".png"),HMTrueFirst)
