    ...
    then 
        comp_id1=$(sbatch --parsable \
                    ...
                    --export=DATASET=${DATA_NAME},COMPAREMETHOD=AIR+VM+Purity ../../rnaSeq/code/compare/compare_job.sh)
        ...
        comp_id2=$(sbatch --parsable \
                    ...
                    --export=DATASET=${DATA_NAME},COMPAREMETHOD=chIndex ../../rnaSeq/code/compare/compare_job.sh)
        ...
        comp_id3=$(sbatch --parsable \
                    ...
                    --export=DATASET=${DATA_NAME},COMPAREMETHOD=cMatrix ../../rnaSeq/code/compare/compare_job.sh)
        ...
        comp_id4=$(sbatch --parsable \
                    ...
                    --export=DATASET=${DATA_NAME},COMPAREMETHOD=heatmap ../../rnaSeq/code/compare/compare_job.sh)
        ...
        comp_id5=$(sbatch --parsable \
                    ...
                    --export=DATASET=${DATA_NAME},COMPAREMETHOD=regGenes ../../rnaSeq/code/compare/compare_job.sh)
